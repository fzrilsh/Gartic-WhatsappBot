...
class Gartic{
    ...
    async setDraw(cb){
        ...
        this.client.sendMessage(this.id, `[/] _@${this.playersQueue.split('@')[0]}'s_ turn to draw`, { mentions: [await this.client.getContactById(this.playersQueue)] })
